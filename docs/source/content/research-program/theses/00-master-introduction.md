...
summary: "A bounded component of the Consullo public research program: Master Introduction."
...
- `00-vocabulary-and-invariants.md`
- `00-cross-thesis-dependency-map.md`
- `appendix-substrates.md`
- `risks-and-criticisms.md`
- `appendix-literature-grounding.md`
